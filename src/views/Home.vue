<template>
  <div class="question-container">
    <div class="create-box">
      <a href="" class="create-box__link">
        <svg class="create-box__icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" width="122.881px" height="122.88px" viewBox="0 0 122.881 122.88" enable-background="new 0 0 122.881 122.88" xml:space="preserve">
          <g>
    ...
    <QuestionItem
      v-for="i in 5"
      :key="i"
      title="Lorem ipsum dolor sit amet consectetur adipisicing elit. Corrupti, vel."
      description="Lorem ipsum dolor, sit amet consectetur adipisicing elit. Asperiores molestias placeat a min repellat harum cupiditate nesciunt! Voluptas, optio..."
      slug="lorem-ipsum-dolor-sit-amet-consectetur-adipisicing elit-corrupti"
      :num-votes="0"
      :num-answers="0"
      asked-by="Seth250"
    />
    ...
    $route: {
      ...
      async handler (newRoute) {
        try {
          ...
          await this.fetchPageQuestions(pageNumber)
        } catch (err) {
          if (err.response) {
